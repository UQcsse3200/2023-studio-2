...
<tileset version="1.10" tiledversion="1.10.2" name="animated_tiles" tilewidth="16" tileheight="16" tilecount="140" columns="10">
 <image source="animated tiles.png" width="160" height="224"/>
 <tile id="0">
  <animation>
