...
public class GdxGame extends Game {
  ...
  public enum ScreenType {
    MAIN_MENU, MAIN_GAME, SETTINGS, TITLE_SCREEN, SPACE_MAP, EXTRACTOR_GAME,  GAME_STORY, PLAYER_DEATH, NAVIGATION_SCREEN, SPACEMINI_SCREEN, UPGRADE_SHOP, CONTROLS_SCREEN
