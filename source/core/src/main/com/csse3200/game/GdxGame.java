...
public class GdxGame extends Game {
  ...
  private Screen newScreen(ScreenType screenType) {
    switch (screenType) {
      ...
      case PLAYER_ANIMATION_SCREEN:
        return new ControlsAnimationScreen(this);
      default:
        return null;
    }
  }
  ...
  public enum ScreenType {
    ...
    GAME_STORY, PLAYER_DEATH,COMPANION_DEATH, NAVIGATION_SCREEN ,INITIAL_SCREEN, SPACEMINI_SCREEN, UPGRADE_SHOP, PLAYER_ANIMATION_SCREEN, INITIALL_SCREEN, PLAYER_DEATH_0, PLAYER_DEATH_1, PLAYER_DEATH_2, PLAYER_DEATH_3
