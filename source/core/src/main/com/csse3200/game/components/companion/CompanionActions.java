...
public class CompanionActions extends Component {
    ...
    private Vector2 handleAttack() {
        // get enemies, and if empty return our current position
        ...
        if (!inCombat) {
            ...
            //This algorithm makes sure that the targetenemy is the CLOSEST enemy to the companion
            ...
            //If there is a closest enemy to attack
            if (targetEnemy != null) {
                //your mode is now in combat
                inCombat = true;
