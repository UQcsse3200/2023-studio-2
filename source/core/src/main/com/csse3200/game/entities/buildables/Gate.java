...
public class Gate extends PlaceableEntity {
    ...
    public Gate(Entity player, GateConfig config) {
        super(2, 2);
        ...
        addComponent(new SaveableComponent<>(gate -> save(gate, config), GateConfig.class));
     ...
     */
    private static GateConfig save(Entity entity, GateConfig config) {
