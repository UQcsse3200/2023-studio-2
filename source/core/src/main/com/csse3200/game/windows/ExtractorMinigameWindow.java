...
public class ExtractorMinigameWindow extends Window {
    ...
    /**
     * @param fire  Attach a click listener to make the fire disappear when clicked with extinguisher
    ...
    /**
     * @param hole  Attach a click listener to make the hole disappear when clicked with spanner
