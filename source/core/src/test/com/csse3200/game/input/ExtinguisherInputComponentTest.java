...
public class ExtinguisherInputComponentTest {

    private ExtinguisherInputComponent inputComponent;
    ...
    public void testTouchDownWithinBoundingBox() {
        ...
        inputComponent = new ExtinguisherInputComponent(terrain, area);
